...
\begin{figure}[H]
	...
	\caption{Przydzielone grupy dla poszczególnych twarzy dla zdjęć nieobrobionych przy 2 grupach}
...
\begin{figure}[H]
	...
	\caption{Przydzielone grupy dla poszczególnych twarzy dla zdjęć nieobrobionych przy 3 grupach}
...
\fbi
Poniżej ilustracje grupowania.

\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{./assets/ilustracja_zad2_eigen_j4_pogrupowane.png}
	\caption{Przydzielone grupy dla poszczególnych twarzy dla zdjęć obrobionych dla~J~=~4}
	\label{fig:ilustracja_zad2_eigen_j4_pogrupowane}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{./assets/ilustracja_zad2_eigen_j10_pogrupowane.png}
	\caption{Przydzielone grupy dla poszczególnych twarzy dla zdjęć obrobionych dla~J~=~10}
	\label{fig:ilustracja_zad2_eigen_j10_pogrupowane}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{./assets/ilustracja_zad2_eigen_j20_pogrupowane.png}
	\caption{Przydzielone grupy dla poszczególnych twarzy dla zdjęć obrobionych dla~J~=~20}
	\label{fig:ilustracja_zad2_eigen_j20_pogrupowane}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{./assets/ilustracja_zad2_eigen_j30_pogrupowane.png}
	\caption{Przydzielone grupy dla poszczególnych twarzy dla zdjęć obrobionych dla~J~=~30}
	\label{fig:ilustracja_zad2_eigen_j30_pogrupowane}
\end{figure}
