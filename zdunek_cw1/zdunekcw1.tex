...
\fbi
Powyższy kod przedstawia zaimplementowaną metodę PCA dla zadanego zbioru danych.

\fbi
W celu obliczenia par własnych macierzy kowariancji zastosowana została dwuargumentowa metoda eigs, w której pierwszym argumentem jest macierz danych, drugim ilość wektorów (wierszy macierzy).
