...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\textwidth]{./assets/ilustracja_zad2_eigen_j20.png}
	\caption{Wyznaczone twarze własne dla J=20}
	\label{fig:ilustracja_zad2_eigen_j20}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\textwidth]{./assets/ilustracja_zad2_eigen_j30.png}
