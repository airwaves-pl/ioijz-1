...
\lstinputlisting[label=lst:zad2b,caption=Główna część skryptu,firstline=50,lastline=500]{./assets/skrypt_zad2_test.m}
...
\lstinputlisting[label=lst:zad2,caption=Fragment skryptu w Matlabie obejmujący klasyfikację k-NN,firstline=80,lastline=100]{./assets/skrypt_zad2_test.m}
